...
os.system("bin/./peeling11_4.1 -pdb data/1aoh.pdb -dssp data/1aoh.dss -R2 95 -ss2 8 -lspu 20 -mspu 0 -d0 6.0 -delta 1.5 -oss 0 -p 0 -cp 0 -npu 16 > results/peeling_output.txt")
...
for itx in text:
    ...
    for i in range(1, nb_pu+2, 2):
        ...
        parse.writePDB(dPDB, filout = "data/fou.pdb")
        break
